...
public class Main {
    public static void main(String[] args) {
        ...
        JMenu colorMenu = new JMenu("textColor");
        ...
        JMenu fontMenu = new JMenu("textFont");
        ...
        rb.addActionListener(actionEvent -> {
            switch(actionEvent.getActionCommand()) {
                ...
                case "Arial":
                    ...
                    break;
                case "OpenSans":
                    area.setFont(new Font("OpenSans", Font.PLAIN, 24));
                    break;
            }
        });
    }
